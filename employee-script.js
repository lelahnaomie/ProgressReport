...
function openTaskModal(taskId) {
    ...
    modalContent.innerHTML = `
        ...
        <div style="background: #fdfdfd; padding: 15px; border: 1px solid #eee; border-radius: 8px;">
            ...
            <button class="btn-approve" onclick="updateMyProgress(${task.id})" style="width: 45%; border:1px solid #149648; border-radius: 4px; align-items:center; left:50%; padding:8px; margin:10px 10px 50% 0; background: #149648;">
                Update progress
            </button>
        </div>
