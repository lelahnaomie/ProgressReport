...
function openTaskModal(taskId) {
    ...
    modalContent.innerHTML = `
        ...
        <div style="background: #fdfdfd; padding: 15px; border: 1px solid #eee; border-radius: 8px;">
            ...
            <button class="btn-approve" onclick="updateMyProgress(${task.id})" style="width: 45%; border:1px solid #149648; border-radius: 4px; justify-content:center; align-items:center; left:80%; padding:10px; margin:10px 0; background: #149648;">
                Update progress
            </button>
        </div>
